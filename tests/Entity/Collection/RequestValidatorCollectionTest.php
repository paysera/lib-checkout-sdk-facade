...
class RequestValidatorCollectionTest extends AbstractCase
{
    ...
    {
        $collection = new RequestValidatorCollection([m::mock(PaymentMethodsRequestValidator::class)]);

        foreach ($collection as $item) {
            $this->assertInstanceOf(
                PaymentMethodsRequestValidator::class,
                $item,
    ...
    {
        $validator1 = $this->container->get(PaymentMethodsRequestValidator::class);
        ...
        $filteredCollection = $collection->filter(
            static fn (RequestValidatorInterface $validator) => get_class($validator) === PaymentMethodsRequestValidator::class
        );
